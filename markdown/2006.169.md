| **HHCC Accession No. 2006.169** |**HHCC Classification Code:  16.01-1**|
| ----------- | ----------- |
##### Description:
...
<figure class="gallery__item"><a href="#DOMAIN_NAME#gallery/16.01-1.jpg" data-size="2150x1110"><img src="#DOMAIN_NAME#gallery/16.01-1-thumbnail.jpg" alt=""></a></figure>
<figure class="gallery__item"><a href="#DOMAIN_NAME#gallery/16.01-1a.jpg" data-size="1555x1429"><img src="#DOMAIN_NAME#gallery/16.01-1a-thumbnail.jpg" alt=""></a></figure>
</div>
</details>
...
##### Make:
Manufacturer's name partially obliterated
...
##### Rating:
Exhibit, education, and research quality, illustrating the engineering and construction of a early 20th century, 25 cycle, alternating current, communtating motor, likely repulsion type
...
Brush riding, 
Two pole, 
Single phase, 25 cycle, alternating current
Dual voltage, 110-220 volts  alternating current motor, 
Likely of the repulsion type. 
Sleeve bronze bearing with snap cap oilers [one missing]
Open, fully ventilated, all steel frame
Cast Iron slotted base
Open leads, no junction box.
