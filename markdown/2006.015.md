| **HHCC Accession No. 2006.015** |**HHCC Classification Code:  7.01-2D**|
| ----------- | ----------- |
##### Description:
...
<figure class="gallery__item"><a href="#DOMAIN_NAME#gallery/7.01-2d.jpg" data-size="1878x1559"><img src="#DOMAIN_NAME#gallery/7.01-2d-thumbnail.jpg" alt=""></a></figure>
</div>
</details>
...
##### Model:
Model E, here without immersion cup, quite likely an earlier version of the model E, without frost protection for the fragile bellows  [see items 7.01- 2E and F for typical failure modes of unprotected bellows] see Note
