| **HHCC Accession No. 2006.180** |**HHCC Classification Code:  16.01-12**|
| ----------- | ----------- |
##### Description:
...
<figure class="gallery__item"><a href="#DOMAIN_NAME#gallery/16.01-12.jpg" data-size="2268x1147"><img src="#DOMAIN_NAME#gallery/16.01-12-thumbnail.jpg" alt=""></a></figure>
<figure class="gallery__item"><a href="#DOMAIN_NAME#gallery/16.01-12a.jpg" data-size="1982x1216"><img src="#DOMAIN_NAME#gallery/16.01-12a-thumbnail.jpg" alt=""></a></figure>
</div>
</details>
##### Group:
...
##### Rating:
Exhibit, education, and research quality, illustrating the engineering and construction of a early 20th century, 25 cycle, alternating current, communtating motor, likely repulsion induction type
...
##### Type and Design:
A mystery motor requiring further study 
Communtating, 
Brush riding, 
Two pole, 
Single phase, 25 cycle, alternating current
Dual voltage, 110-220 volts  alternating current motor, 
Likely of the repulsion induction type. 
Sleeve bronze bearing with open oil wicking 
Open, fully ventilated frame, 
Cast Iron base, 4 bolt mount
